...
local ORIGINS = {
	left = function(options)
		return { x = options.fromPosition or -Vars.titleSize * 2 }, "x"
	end,
	right = function(options)
		return { x = options.fromPosition or love.graphics.getWidth() }, "x"
	end,
	bottom = function(options)
		return { y = options.fromPosition or love.graphics.getHeight() }, "y"
	end,
	top = function(options)
		return { y = options.fromPosition or -Vars.titleSize * 2 }, "y"
	end,
}
