local love_version = "12.0"

function love.conf(t)
	t.identity = "SolfeGuido" -- The name of the save directory (string)
	t.appendidentity = false -- Search files in source directory before save directory (boolean)
	t.version = love_version -- The LÖVE version this game was made for (string)
	...
	t.releases = {
		...
		loveVersion = love_version, -- The project LÖVE version
		version = "1.7", -- The project version
		author = "Azarias", -- Your name (string)
		email = "solfeguido@gmail.com", -- Your email (string)
